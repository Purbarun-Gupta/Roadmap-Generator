            ...
            <div className="flex items-center gap-2 p-1.5 rounded-2xl bg-[#0a0f18] border border-white/5 shadow-xl">
              ...
              {filters.map((f) => (
                <Button 
                  ...
                  size="sm" 
                  onClick={() => setFilter(f)}
                  className={`rounded-xl text-[11px] font-bold px-5 h-9 transition-all ${
                    filter === f 
            ...
            {filtered.map((r, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="group p-6 rounded-[2rem] bg-[#0a0f18] border border-white/5 hover:border-[#10b981]/30 shadow-2xl transition-all flex flex-col h-full"
                >
                  <div className="flex items-center justify-between mb-5">
                    ...
                    <span className={`text-[10px] font-black uppercase px-2.5 py-1 rounded-md tracking-tighter ${
                      r.difficulty === "Beginner" ? "bg-emerald-500/10 text-emerald-500 border border-emerald-500/10" :
